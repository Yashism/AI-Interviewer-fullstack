...
export default function GaugeCircle({
  ...
  return (
    ...
    >
      ...
      <div className="items-center text-center justify-center rounded-md py-2 text-xl font-semibold text-white dark:from-white dark:to-slate-900/10 ">Interviews Given</div>
          </div>
    </div>
  );
}
